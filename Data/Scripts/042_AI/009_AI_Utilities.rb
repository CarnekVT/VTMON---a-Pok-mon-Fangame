...
class Battle::AI
  ...
  BASE_ABILITY_RATINGS = {
    10 => [:DELTASTREAM, :DESOLATELAND, :HUGEPOWER, :MOODY, :PARENTALBOND,
           :POWERCONSTRUCT, :PRIMORDIALSEA, :PUREPOWER, :SHADOWTAG, :ABYSSALROMP,
           :STANCECHANGE, :WONDERGUARD,:GREATENCORE],
    ...
    8  => [:ADAPTABILITY, :AERILATE, :CONTRARY, :DISGUISE, :DRAGONSMAW,
           ...
           :SIMPLE, :SNOWWARNING, :TECHNICIAN, :TRANSISTOR, :WATERBUBBLE, :DELUSIVEFLAME],
    7  => [:BEASTBOOST, :BULLETPROOF, :COMPOUNDEYES, :DOWNLOAD, :FURCOAT,
           :HUSTLE, :ICESCALES, :INTIMIDATE, :SAGACITY, :DIVINEINSPIRATION, :LEVITATE, :LIGHTNINGROD,
           :MEGALAUNCHER, :MOLDBREAKER, :MOXIE, :VIRALGROWTH, :NATURALCURE, :SAPSIPPER, :CITRUSBULLET,
           :SHEDSKIN, :PATCH, :SKILLLINK, :SOULHEART, :STORMDRAIN, :TERAVOLT, :THICKFAT,
           :TINTEDLENS, :TOUGHCLAWS, :TRIAGE, :TURBOBLAZE, :UNBURDEN,
           :VOLTABSORB, :WATERABSORB, :MIRACULOUSSONG],
    6  => [:BATTLEBOND, :CHLOROPHYLL, :COMATOSE, :DARKAURA, :DRYSKIN,
           :FAIRYAURA, :FILTER, :ANTIVIRUS, :FLASHFIRE, :FORECAST, :GALEWINGS, :GUTS,
           ...
           :TRACE, :CURIOUSINSTINCT, :UNAWARE, :VICTORYSTAR, :UNILATERALPLANE, :ENCRYPTED],
    5  => [:AFTERMATH, :AIRLOCK, :ANALYTIC, :BERSERK, :BLAZE, :CLOUDNINE,
           ...
           :MARVELSCALE, :MUMMY, :NEUTRALIZINGGAS, :BUGGEDAURA, :OVERCOAT, :OVERGROW,
    ...
    4  => [:ANGERPOINT, :BADDREAMS, :CHEEKPOUCH, :CLEARBODY, :CURSEDBODY,
           ...
           :SYNCHRONIZE, :VITALSPIRIT, :WATERCOMPACTION, :WATERVEIL, :CORRUPTOR,
